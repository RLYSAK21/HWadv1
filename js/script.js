...
"Вартість всіх заокруглених товарів : ", truncSum, "</br>",
"Вартість всіх товарів округлена до сотень : ", sumFixedToHundreds, "</br>",
"Булеве значення (парне чи не парне) : ",boolean, "</br>",
"Решта, при оплаті товарів купюрою 500 : ", 500 - sum, "</br>",
"Середнє значення цін : ", middlePrice, "</br>",
"Знижка : ", randomNumbers, "%", "</br>",
"Сума до оплати з знижкою : ", priceWithDiscount, "</br>",
"Чистий прибуток, якщо клієнт заплатив зі знижкою : ", (priceWithDiscount- netSum).toFixed(2))
